...
//#region node_modules/.nitro/vite/services/ssr/assets/router-ByjKII8X.js
var router_ByjKII8X_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DNDE-OeE.css";
var APP_NAME = "Rudra Priye";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Student portfolio of Rudra Priye — Class XI, section M1, PCM. Basketball, strength training, and the academic record in between."
			},
			{
				name: "theme-color",
				content: "#0c0d0c"
...
var $$splitComponentImporter = () => import("./routes-D8v51p7Q.mjs");
...
//#endregion
export { getRouter, router_ByjKII8X_exports as t };
